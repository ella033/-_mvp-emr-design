...
const GeneralMedical: React.FC<GeneralMedicalProps> = ({
  ...
  const [selectedInsuranceType, setSelectedInsuranceType] = useState<string>(
    String(currentInsuranceInfo?.uDeptDetail || 보험구분상세.일반)
  );
  ...
  return (
    <div className="relative" style={{ paddingRight: "calc(155px + 1rem)" }}>
      ...
      >
        ...
        {/* row2: 공란 (input p-1 높이만큼) */}
        <div className="col-span-4 h-[26px]" />
